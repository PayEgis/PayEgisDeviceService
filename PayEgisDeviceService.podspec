...
Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '8.0'
  s.source       = { :git => "https://github.com/PayEgis/PayEgisDeviceService.git", :tag => "5.0.1"  }
  # s.source_files  = "Classes/*.framework"
  s.vendored_frameworks   = 'Classes/*.framework'
  s.ios.frameworks        = 'CoreLocation', 'CFNetwork', 'SystemConfiguration', 'CoreGraphics', 'CoreTelephony'
  s.requires_arc = true
end
